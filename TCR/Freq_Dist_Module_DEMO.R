# SCRIPT CONTAINS MODULE FOR PRODUCING 'Frequency Distribution' TAB OF THE TCR ANALYSIS WEBSITE
# To Test this module:
...
####    read.csv(my_file_path(),sep="\t",as.is = 1,header = TRUE)
  ...
  output$downloadTable <- downloadHandler(
    # CREATE SENSIBLE FILENAME (doesn't work)
  ...
  # DOWNLOAD WHATEVER plot1 IS (doesn't work)
